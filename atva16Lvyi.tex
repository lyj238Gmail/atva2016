...
focus on a real-world cache coherence protocol - Stanford FLASH protocol \cite{FLASHCache}. %The core of
...
its main memory in the corresponding directory headers.
 ...
 There are typical kinds of transactions as follows:\\%\begin{description}%\item[READ-Transaction]
...
%\center (a) The unsymmetrical version\\
%\twoSpaces \\
\end{minipage}
